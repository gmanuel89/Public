...
# Before we start
Tk().withdraw()
tkMessageBox.showinfo(title="Mascot output converter", message="This application will replace each 'Accession' name with the correspondent specific protein code")

# Message for selection (open)
Tk().withdraw()
tkMessageBox.showinfo(title="Mascot CSV file selection", message="Select the Mascot CSV file to be converted")
...
Tk().withdraw()
tkMessageBox.showinfo(title="CSV file selection", message="Select where to save the converted CSV file")
...
# Conversion done!
Tk().withdraw()
tkMessageBox.showinfo(title="Mascot CSV conversion done", message="The conversion has been successfully performed!")
