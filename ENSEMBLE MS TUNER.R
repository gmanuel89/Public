...
model_tuning <- TRUE
model_tuning_mode <- "after"
selection_metric <- "Accuracy"
automatically_select_features <- FALSE
generate_plots <- TRUE
cv_repeats_control <- 5
k_fold_cv_control <- 3
...
outcome_list_function <- function() {
    ...
    if (!is.null(class_list)) {
        ...
        submit_outcome_list_function <- function() {
            ...
            outcome_list_value <- "OUTCOME LIST\nSET"
            outcome_list_value_label <- tklabel(window, text = outcome_list_value, font = label_font, bg = "white", width = 30)
        ...
        class_list_values_label <- tklabel(outcome_list_window, text = class_list_values, font = label_font, bg = "white", width = 30)
        outcome_list_label <- tklabel(outcome_list_window, text = "Outcome list\n(separated by comma)", font = label_font, bg = "white", width = 20)
        outcome_list_entry <- tkentry(outcome_list_window, width = 20, textvariable = outcome_list_input, font = entry_font, bg = "white", width = 30)
...
preprocessing_choice <- function() {
    ...
    if (isTRUE(try_combination_of_parameters)) {
        ...
        # Set the value of the displaying label
        preprocessing_value_label <- tklabel(window, text = preprocessing_value, font = label_font, bg = "white", width = 20, height = 2)
        tkgrid(preprocessing_value_label, row = 4, column = 4)
    }
    # Escape the function
    .GlobalEnv$preprocessing <- preprocessing
    .GlobalEnv$preprocessing_value <- preprocessing_value
}

##### Peaklist file
file_import_function <- function() {
    filepath_import_select <- tkmessageBox(title = "Input file", message = "Select the peaklist file containing all the mass spectrometric data", icon = "info")
    filepath_import <- tclvalue(tkgetOpenFile(filetypes = "{{Comma Separated Value files} {.csv}}"))
    ...
    if (filepath_import != "") {
        ...
        # Non signals (columns)
        tkmessageBox(title = "Demographical data", message = "Select the demographical data (to be separated from the mass spectrometric data)", icon = "info")
        non_features <- select.list(feature_vector, title = "Demographical features", multiple = TRUE)
        ...
        discriminant_attribute <- select.list(c(non_features, "NONE"), title = "Discriminant attribute", preselect = ifelse("Class" %in% feature_vector, "Class", NULL))
        ...
        .GlobalEnv$peaklist <- peaklist
        .GlobalEnv$input_filename <- input_filename
        .GlobalEnv$feature_vector <- feature_vector
        .GlobalEnv$non_features <- non_features
        .GlobalEnv$discriminant_attribute <- discriminant_attribute
...
model_tuning_choice <- function() {
    ...
    # Default
    if (model_tuning_mode == "") {
        model_tuning_mode <- "None"
    }
    # Fix the values
    if (model_tuning_mode == "None") {
        model_tuning <- FALSE
    ...
    .GlobalEnv$model_tuning_value <- model_tuning_value
}
...
automatically_select_features_choice <- function() {
    ...
    if (automatically_select_features == "NO" || automatically_select_features == "") {
        automatically_select_features <- FALSE
    }
    # Set the value of the displaying label
    if (automatically_select_features == TRUE) {
...
generate_plots_choice <- function() {
    ...
    tkgrid(generate_plots_value_label, row = 2, column = 4)
    # Escape the function
    .GlobalEnv$generate_plots <- generate_plots
    .GlobalEnv$generate_plots_value <- generate_plots_value
}
...
try_combination_of_parameters_choice <- function() {
    ...
    if (try_combination_of_parameters == "NO" || try_combination_of_parameters == "") {
        try_combination_of_parameters <- FALSE
        preprocessing <- c("center", "scale")
        feature_reranking <- FALSE
    }
    ...
    tkgrid(try_combination_of_parameters_value_label, row = 4, column = 2)
    preprocessing_value_label <- tklabel(window, text = preprocessing_value, font = label_font, bg = "white", width = 20, height = 2)
    tkgrid(preprocessing_value_label, row = 4, column = 4)
    feature_reranking_value_label <- tklabel(window, text = feature_reranking_value, font = label_font, bg = "white", width = 20, height = 2)
    tkgrid(feature_reranking_value_label, row = 4, column = 6)
    # Escape the function
...
run_ensemble_ms_tuner_function <- function() {
    ...
    if (!is.null(filepath_import) && !is.null(outcome_list)) {
        ...
        model_ensemble_tuner <- model_ensemble_embedded_fs(peaklist = peaklist, features_to_select = features_to_select, model_tuning = model_tuning_mode, selection_metric = selection_metric, discriminant_attribute = discriminant_attribute, non_features = non_features, seed = 12345, automatically_select_features = automatically_select_features, generate_plots = generate_plots, cv_repeats_control = cv_repeats_control, k_fold_cv_control = k_fold_cv_control, preprocessing = preprocessing, allow_parallelization = allow_parallelization, feature_reranking = feature_reranking, try_combination_of_parameters = try_combination_of_parameters, outcome_list = outcome_list, progress_bar = "tcltk")
...
#### Browse
# Library
file_import_button <- tkbutton(window, text = "BROWSE\nPEAKLIST...", command = file_import_function, font = button_font, bg = "white", width = 20)
# Output
...
#### Entries
# Preprocessing
preprocessing_entry <- tkbutton(window, text = "PREPROCESSING", command = preprocessing_choice, font = button_font, bg = "white", width = 20)
# Model tuning mode
model_tuning_entry <- tkbutton(window, text = "MODEL\nTUNING", command = model_tuning_choice, font = button_font, bg = "white", width = 20)
# Automatially select features
automatically_select_features_entry <- tkbutton(window, text = "AUTOMATICALLY\nSELECT\nFEATURES", command = automatically_select_features_choice, font = button_font, bg = "white", width = 20)
# Generate plots
generate_plots_entry <- tkbutton(window, text = "GENERATE\nPLOTS", command = generate_plots_choice, font = button_font, bg = "white", width = 20)
# Combination of parameters
try_combination_of_parameters_entry <- tkbutton(window, text = "COMBINATION\nOF\nPARAMETERS", command = try_combination_of_parameters_choice, font = button_font, bg = "white", width = 20)
# Feature reranking
feature_reranking_entry <- tkbutton(window, text = "FEATURE\nRERANKING", command = feature_reranking_choice, font = button_font, bg = "white", width = 20)
# File type export matrix
...
# Selection metric
selection_metric_entry <- tkbutton(window, text = "SELECTION\nMETRIC", command = selection_metric_choice, font = button_font, bg = "white", width = 20)
# Multicore
...
feature_reranking_value_label <- tklabel(window, text = feature_reranking_value, font = label_font, bg = "white", width = 20, height = 2)
selection_metric_value_label <- tklabel(window, text = selection_metric, font = label_font, bg = "white", width = 20)
filename_export_label <- tklabel(window, text = "<--- Set the file name", font = button_font, bg = "white", width = 20)
check_for_updates_value_label <- tklabel(window, text = check_for_updates_value, font = label_font, bg = "white", width = 20)
k_fold_cv_control_label <- tklabel(window, text = "K value of k-fold\ncross-validation", font = button_font, bg = "white", width = 20)
cv_repeats_control_label <- tklabel(window, text = "Cross-validation\niterations", font = button_font, bg = "white", width = 20)
features_to_select_label <- tklabel(window, text = "Number of features\nto be selected", font = button_font, bg = "white", width = 20)
...
tkgrid(features_to_select_label, row = 2, column = 1, padx = c(10, 10), pady = c(10, 10))
tkgrid(features_to_select_entry, row = 2, column = 2, padx = c(10, 10), pady = c(10, 10))
tkgrid(model_tuning_entry, row = 2, column = 3, padx = c(10, 10), pady = c(10, 10))
tkgrid(model_tuning_value_label, row = 2, column = 4, padx = c(10, 10), pady = c(10, 10))
tkgrid(selection_metric_entry, row = 2, column = 5, padx = c(10, 10), pady = c(10, 10))
tkgrid(selection_metric_value_label, row = 2, column = 6, padx = c(10, 10), pady = c(10, 10))
tkgrid(automatically_select_features_entry, row = 3, column = 1, padx = c(10, 10), pady = c(10, 10))
tkgrid(automatically_select_features_value_label, row = 3, column = 2, padx = c(10, 10), pady = c(10, 10))
tkgrid(cv_repeats_control_label, row = 3, column = 3, padx = c(10, 10), pady = c(10, 10))
tkgrid(cv_repeats_control_entry, row = 3, column = 4, padx = c(10, 10), pady = c(10, 10))
tkgrid(k_fold_cv_control_label, row = 3, column = 5, padx = c(10, 10), pady = c(10, 10))
tkgrid(k_fold_cv_control_entry, row = 3, column = 6, padx = c(10, 10), pady = c(10, 10))
tkgrid(preprocessing_entry, row = 4, column = 3, padx = c(10, 10), pady = c(10, 10))
tkgrid(preprocessing_value_label, row = 4, column = 4, padx = c(10, 10), pady = c(10, 10))
tkgrid(feature_reranking_entry, row = 4, column = 5, padx = c(10, 10), pady = c(10, 10))
tkgrid(feature_reranking_value_label, row = 4, column = 6, padx = c(10, 10), pady = c(10, 10))
tkgrid(try_combination_of_parameters_entry, row = 4, column = 1, padx = c(10, 10), pady = c(10, 10))
tkgrid(try_combination_of_parameters_value_label, row = 4, column = 2, padx = c(10, 10), pady = c(10, 10))
...
tkgrid(file_import_button, row = 7, column = 3, padx = c(10, 10), pady = c(10, 10))
tkgrid(run_ensemble_ms_tuner_function_button, row = 7, column = 4, padx = c(10, 10), pady = c(10, 10))
tkgrid(end_session_button, row = 7, column = 5, padx = c(10, 10), pady = c(10, 10))
